...
/* Fork diagnostics used by the V4.1 DSpark profiling paths. */
...
/* Fork-only V4.1 decode kernels retained across the upstream header split. */
...
/* Raise the selected-expert cache budget without discarding resident entries. */
